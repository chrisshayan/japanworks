...
class CI_Email {
    ...
    protected function _build_message() {
        ...
        for ($i = 0; $i < count($this->_attach_name); $i++) {
            ...
            //fix for japanese
            if ($this->_attach_new_name[$i] != NULL) {
                if ($basename == '.pdf' || $basename == '.doc' || $basename == '.docx') {
                    $basename = $this->_attach_new_name[$i];
                }
            }
//if(basename($filename)=='.pdf' || basename($filename)=='.doc')
