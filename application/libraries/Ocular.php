...
class Ocular {
	...
	var $full_active_controller;
	var $active_controller;
	var $active_function;
	var $_show_function;
	var $_show_controller;
	...
	function render($name = '') {
		...
		if ( empty($name) ) {
			...
			$filepath = APPPATH . $this->CI->config->item('OCU_view_dir') . "/" . $this->CI->config->item('OCU_template_dir') . "/" . $cont . ".php";
...
/* Location: ./system/application/libraries/Ocular.php */