...
class linkedin {
    ...
    function get_request_token() {
        $args = array('scope' => 'r_basicprofile r_emailaddress');
    ...
    function httpRequest($url, $auth_header, $method, $body = NULL) {
        ...
        curl_setopt($curl, CURLOPT_HTTPHEADER, array($auth_header, "Content-Type: text/xml;charset=utf-8")); // Set the headers.
