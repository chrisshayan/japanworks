        ...
        <div id="wrapper">
            ...
            <div class="container" id="section2">
                <ol class="breadcrumb">
                    ...
                    <li>Cơ hội được rèn luyện tiếng Nhật</li>
                </ol>

                <div class="benefit-title">
                    <span class="glyphicon glyphicon-gift"></span>
                    Cơ hội được rèn luyện tiếng Nhật
                </div>
            </div>
            <div class="container" id="section2">
                <div class="row">
                        ...
                        <div class="panel" id="content">
                            ...
                            <div class="panel-body" id="results">
                                ...
                                <?php if (isset($data->jobs) && !empty($data->jobs)): ?>
                                    <p class="mb10 search_msg"><strong>Tuyển dụng <span class="txtRed total"><?php echo $data->total; ?></span> công việc với "Cơ hội được rèn luyện tiếng Nhật".</strong></p>
                                    <?php
