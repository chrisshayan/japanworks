        ...
        <div id="wrapper">
            ...
            <div class="container" id="section2">
                <ol class="breadcrumb">
                    ...
                    <li>Cơ hội làm việc tại Nhật Bản</li>
                </ol>
                        ...
                        <div class="panel" id="content">
                            ...
                            <div class="panel-body" id="results">
                                ...
                                <?php if (isset($data->jobs) && !empty($data->jobs)): ?>
                                    <p class="mb10 search_msg"><strong>Tuyển dụng <span class="txtRed total"><?php echo $data->total; ?></span> công việc với "Cơ hội làm việc tại Nhật Bản".</strong></p>
                                    <?php
