...
<html>
    <head>
        ...
        <title>Công việc tiếng Nhật mới trong 3 ngày gần nhất- JapanWorks</title>
                ...
                <div class="wrapper wrapper-content">
                    <div class="container" id="section2">
                        <ol class="breadcrumb">
                            ...
                            <li>Công việc tiếng Nhật mới trong 3 ngày gần nhất</li>
                        </ol>

                        <div class="row">
                            <div class="col-sm-12 big_photo">
                                <div><img src="<?php echo base_url("static/img/new-jobs-banner.jpg"); ?>" width="100%" class="img-responsive" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="panel" id="content">
                                    ...
                                    <div class="panel-body" id="results">
                                        ...
                                        <?php if (isset($data->jobs) && !empty($data->jobs)): ?>
                                            <p class="mb10 search_msg"><strong>Tuyển dụng <span class="txtRed total"><?php echo $data->total; ?></span>  công việc tiếng Nhật mới trong 3 ngày gần nhất.</strong></p>
                                            <?php
