                ...
                if ($job->job_post_plus == "1" & $job->is_show_job_image == "1") {
                    if ($job->featured_job == "1") {
                        ...
                        <li>
                            ...
                            <br>
                            <span class="job-level text-clip" data-original-title="" title=""><em>Job level:</em> <?php echo $job->job_level ?></span>
                            <br>
                            <span class="job-location text-clip"><em>Location:</em>
                                <?php
                            ...
                            <br>
                            <span class="job-salary"><em>Salary:</em><span class="orange"> <?php echo $job->salary ?></span></span>
                        </li>
                        <?php
                    }
                }
