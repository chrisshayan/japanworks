<div class="container">
    <div class="middle-box text-center loginscreen animated fadeInDown login_page">
        <div>
            ...
            <form id="form_login" class="m-t" role="form" method="post">
                ...
                <button type="submit" name="login"  class="btn btn-primary block full-width m-b">Xác nhận</button>
                <input type="hidden" id="isSent" name="isSent" value="OK" />
                <a href="<?php echo site_url('login/forgotPassword'); ?>"><small>Quên mật khẩu?</small></a> <br>
                <p class="text-muted text-center"><small>Chưa có tài khoản?</small></p>
                <a class="btn btn-sm btn-white btn-block" href="<?php echo site_url('register'); ?>">Tạo tài khoản</a>
            </form>
