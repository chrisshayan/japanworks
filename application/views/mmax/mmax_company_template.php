...
<div style="width:100%; box-sizing:border-box; background-color:#e9e9e9;color:#555;padding:10px;">
    ...
    <div style="background-color:#fff;padding:20px; font-size:16px; line-height:1.5; font-family:arial,tahoma,verdana">
        media max japan (vietnam) co. ltd.,<br>
        担当者様<br>
        <br>
        media max japan (vietnam) co. ltd., 様向けVietnamWorks特別求人ページより応募がありました。<br>
        ご確認ください。<br>
      ...
      <?php if (isset($data['inforstore']['phonenumber']) && $data['inforstore']['phonenumber'] != '') { ?>
                <tr>
                    <td>電話番号</td>
                    <td>: <?php echo $data['inforstore']['phonenumber']
                ?></td>
                </tr>
            <?php } ?>
            <tr>
            ...
            <?php if ($data['checkoption'] == "true"): ?>
                <tr>
                    <td>誕生日</td>
                    <td>: <?php echo $data['inforstore']['yearofbirth'] ?>
                    </td>
                </tr>
                <tr>
                    <td>経験年数</td>
                    <td>:
                        <?php echo $data['experienced'] ?>
                    </td>
                </tr>
