    ...
    <div class="middle-box text-center" style="margin-top: 0px;">
        <form id="form_post" role="form" method = "post">
            <div class="form-group">
                <input id="poster" name="poster" type="text" class="form-control" placeholder="Name of poster" required >
            </div>
            <div class="form-group"  id="data_1">

                <div class="input-group date">
                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="startdate" name="startdate"  type="text" class="form-control" placeholder="Start date">
                </div>
            </div>
            <div class="form-group"  id="data_2">

                <div class="input-group date">
                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="enddate" name="enddate"  type="text" class="form-control" placeholder="End date">
                </div>
            </div>

            <div class="form-group">
                <input id="leveltag" name="leveltag" type="text" class="form-control" placeholder="Level tag" required >
            </div>
            <div class="form-group">
                <input id="prize" name="prize" type="text" class="form-control" placeholder="Prize" required >
            </div>
            <div class="form-group">
