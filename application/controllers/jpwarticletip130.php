...
class Jpwarticletip130 extends MY_Controller {
    ...
    public function insert() {
        if ($this->input->post('isSent') == 'OK') {
            ...
            $this->form_validation->set_rules('inputTextJP', 'please input text JP.', 'trim|required');
            $this->form_validation->set_rules('inputKeyword', 'please input keyword.', 'trim|required');
            $this->form_validation->set_rules('inputTag', 'please input tags.', 'trim|required');
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($insertArtitcle) {
                    redirect(site_url('jpwarticletip130/thanks'));
                }
            }
        }
