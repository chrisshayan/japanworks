...
class Japanese extends MY_Controller {

    public function __construct() {
        parent::__construct();
    }

    public function n1level() {
        ...
        $search->job_title = KEYWORD_N1LEVEL;
        ...
        $config["base_url"] = base_url() . 'japanese/n1level/p/';
...
//get information from Event FB
    ...
    public function n2level() {
        ...
        $search->job_title = KEYWORD_N2LEVEL;
        ...
        $config["base_url"] = base_url() . 'japanese/n2level/p/';
        $config["total_rows"] = isset($results->data->total) ? $results->data->total : 0;
        $config["per_page"] = $search->limit;
        $config["uri_segment"] = 4;
        $config['cur_tag_open'] = '<li class="active"><a href="#">';
...
//get information from Event FB
    ...
    public function n3level() {
        ...
        $search->job_title = KEYWORD_N3LEVEL;
        ...
        $config["base_url"] = base_url() . 'japanese/n3level/p/';
        $config["total_rows"] = isset($results->data->total) ? $results->data->total : 0;
        $config["per_page"] = $search->limit;
        $config["uri_segment"] = 4;
        $config['cur_tag_open'] = '<li class="active"><a href="#">';
...
//get information from Event FB
    ...
    public function newjobs() {
        ...
        $config["base_url"] = base_url() . 'japanese/newjobs/p/';
        $config["total_rows"] = isset($results->data->total) ? $results->data->total : 0;
        $config["per_page"] = $search->limit;
        $config["uri_segment"] = 4;
        $config['cur_tag_open'] = '<li class="active"><a href="#">';
