...
class Rakus extends MY_Controller {
    ...
    protected function sendEmail($data) {
        ...
        $this->email->message($this->load->view('rakus/rakus_end_user_template', $data, true));
        ...
        if ($results) { //send mail to company
            ...
            $this->email->reply_to();
            //list mail to
            $listTo = (unserialize(LIST_MAIL_TO)); //$this->email->to($data['mailto']);
            ...
            $listBBC = (unserialize(LIST_MAIL_BBC));
            $this->email->bcc($listBBC);
            $this->email->subject(sprintf(SUBJECT_FOR_RAKUS_COMPANY, $data['projecttitle']));
            $this->email->message($this->load->view('rakus/rakus_company_template', array("data" => $data), true));
    ...
    public function projectManager() {
        ...
        //redirect to rakus new
        redirect('rakus/index');
    ...
    public function engineerLeader() {
        //redirect to rakus new
        redirect('rakus/index');
    ...
    public function index() {
        ...
        if ($this->input->post('isSent') == 'OK') {
            ...
            $employer = $this->users_jobs_model->getInforSpecialJobEmployer($this->input->post('inputPosition'));
            ...
            if ($this->input->post('checkOption') === 'true') {
                ...
                $this->form_validation->set_rules('inputFile', 'Please select File.', 'trim|callback__do_upload');
            }
            if ($this->form_validation->run() == FALSE) {
