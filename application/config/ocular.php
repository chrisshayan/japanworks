...
|
*/
$config['OCU_template_dir'] = "layouts";
...
*/
$config['OCU_stylesheet_path'] = base_url(). "common/css/";
$config['OCU_javascript_path'] = base_url(). "common/js/";
$config['OCU_images_path'] = base_url(). "common/img/";
